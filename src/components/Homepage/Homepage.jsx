            ...
            <div id='introduction-outer'>
                <div id='introduction'>
                    <div id='text-container'>
                        ...
                        <h3>ייצוג וייעוץ בתחומי ביטוח לאומי</h3>
                    </div>
                </div>
            ...
            <div id='homepage-content-container'>
                ...
                <div id='homepage-flexer'>
                    <div className='homepage-content'>
                        ...
                        <div>שירותי ייעוץ וליווי מקצועיים בתחומי ביקורות ניכויים וגבייה של המוסד לביטוח לאומי ע"י עורך דין מומחה ומנוסה.
                    ...
                    <div className='homepage-content'>
                        ...
                        <div>יגאל אלקובי, עורך דין, ניהל שנים רבות את אגף ביקורת ניכויים במוסד לביטוח לאומי. מומחה בתחומי הגבייה וביקורות ניכויים של המוסד לביטוח לאומי ושל מס הכנסה.
                        </div>
                    </div>
                    <div className='homepage-content'>
                        <div className='icons-container'>
                        ...
                        <div>התמודדות מועילה מול ביקורות ניכויים ותביעות דמי ביטוח. <br />
                    ...
                    <div className='homepage-content'>
                        ...
                        <div>עם הכוונה מקצועית וייעוץ מועיל תוכלו למקסם את מירב זכויותיכם מול המוסד לביטוח לאומי ולחסוך עלויות מיותרות. </div>
                    </div>
                </div>
